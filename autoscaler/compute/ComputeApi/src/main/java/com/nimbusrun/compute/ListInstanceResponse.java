...
public record ListInstanceResponse(List<Instance> instances) {
    ...
    public static class Instance {
        ...
        public Instance(String name, String instanceId, String instanceName, Long instanceCreateTimeInMilli) {
            this.name = name;
        ...
        public Instance(String name, String instanceId, String instanceName, Long instanceCreateTimeInMilli, Object extraProperties) {
            this.name = name;
            this.instanceId = instanceId;
            this.instanceName = instanceName;
            this.instanceCreateTimeInMilli = instanceCreateTimeInMilli;
