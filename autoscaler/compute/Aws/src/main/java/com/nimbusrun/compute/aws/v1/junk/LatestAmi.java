...
public class LatestAmi {
  ...
  public static void main(String[] args) {
    latestAmi(Ec2Client.builder().region(Region.US_EAST_1).build(), ProcessorArchitecture.X64,
        AwsOperatingSystem.UBUNTU_23_04);
  }
  ...
  public static Optional<String> latestAmi(Ec2Client ec2Client, ProcessorArchitecture architecture,
      AwsOperatingSystem os) {
    ...
    try {
      ...
      Utils.excessiveErrorLog("Error finding latest Ubuntu AMI due to %s".formatted(e.getMessage()),
          e, log);
