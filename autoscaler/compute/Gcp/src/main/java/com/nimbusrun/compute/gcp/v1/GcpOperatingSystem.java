...
public enum GcpOperatingSystem {
    ...
    public String createRegex(){
        return switch (this){
            case UBUNTU_20_04, UBUNTU_22_04, UBUNTU_23_04, UBUNTU_24_04, UBUNTU_25_04 -> "^(ubuntu).*?(%s).*".formatted(this.version);
    ...
    public String gcpProviderProject(){
        return switch (this){
            case UBUNTU_20_04, UBUNTU_22_04,UBUNTU_23_04, UBUNTU_24_04, UBUNTU_25_04 -> "ubuntu-os-cloud";
    ...
    public static class Deserialize extends JsonDeserializer<GcpOperatingSystem> {
        ...
        @Override
        public GcpOperatingSystem deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JacksonException {
